...
var indexPage, adminPage, adminScript, contextScript, clientScript, nakedSliceScript, client, algoMessageBoxScript;
...
fs.readFile('../api/msgBoxAPI/AlgoMessageBox.js', function (err, data) {
    if (err) {
        throw err;
    }
...
//listenr.on(indexReady, function())
