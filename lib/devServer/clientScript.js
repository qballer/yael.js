...
yaelClient.genericClient = new function(){
	...
	yaelClient.socket.on('nakedSlice', function(object){
		...
		myNakedSlice.buffer = bitView;

		yaelClient.genericClient.addLine("sending slice to client.js");
		for (var i = 0 ; i < 16 ; i++){
           yaelClient.genericClient.addLine("myNakedSlice.buffer[i] "+myNakedSlice.buffer[i]);
          }
