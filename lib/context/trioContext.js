...
var layer = function(){
	...
	var createContext = function (pathToAlgoFolder,algoID, resultCallbackToAdmin, flipContinueFlag){
		if (ctxt !== null){
		...
		ctxt.closeNetwork = flipContinueFlag;
	...
	*/
	...
	that.startPlugin = function (pathToAlgoFolder, algoID, resultCallbackToAdmin, flipContinueFlag){
		console.log('resultCallbackToAdmin from control:' + resultCallbackToAdmin);
		createContext(pathToAlgoFolder,algoID, resultCallbackToAdmin, flipContinueFlag);
