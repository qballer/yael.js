...
var layer = function(){
	...
	var createContext = function (pathToAlgoFolder,algoID, resultCallback){
		if (ctxt !== null){
		...
		ctxt.giveResult = resultCallback;
	...
	*/
	...
	that.startPlugin = function (pathToAlgoFolder, algoID, resultCallback){
		createContext(pathToAlgoFolder,algoID, resultCallback);
